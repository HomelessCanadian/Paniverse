...
const filterTerms = [
    ...
    'tablespoon', '(tbsp)', 'tbsp', 'tablespoons', '(tbsp)s', 
    'teaspoon', '(tsp)', 'tsp', 'teaspoons', '(tsp)s',
    'ounce', '(oz)', 'oz', 'ounces', '(oz)s',
    'pound', '(lb)', 'lb', 'pounds', '(lb)s',
    'gram', '(g)', 'g', 'grams', '(g)s',
    'milliliter', '(ml)', 'ml', 'milliliters', '(ml)s',
    'liter', '(L)', 'L', 'liters', '(L)s',
    'pinch', 'dash',
    'chopped', 'squeezed', 'peeled', 'diced', 'sliced', 'minced', 'grated', 'shredded', 'crushed', 'pureed', 'roasted', 'boiled', 'steamed', 'fried', 'baked', 'freshly squeezed',
    'of', 'and', 'with', 'for',
    'to taste', 'to preference', 'to desired consistency',
    'until', 'until golden brown', 'until tender', 'until cooked through', 'until lightly browned', 'until slightly softened',
    'in a bowl', 'in a saucepan', 'in a skillet', 'in a pot', 'in a Dutch oven',
    'over medium heat', 'over low heat', 'over high heat',
    'in a preheated oven', 'at room temperature',
    'at 350°F', 'at 375°F', 'at 400°F', 'at 425°F', 'at 450°F', 'at 500°F', 'at 550°F', 'at 600°F',
    'optional', 'or', 'as needed', 'if desired',
    'to garnish', 'for serving', 'before cooking', 'after cooking', 'while cooking'
];
